...
class Javlibrary(Parser):
    ...
    def search(self, number):
        ...
        #self.specifiedUrl = input('Please input specifiedUrl: ')
    ...
    def queryNumberUrl(self, number: str):
        queryUrl = "http://www.javlibrary.com/ja/vl_searchbyid.php?keyword=" + number
        ...
        if queryResult and "/?v=jav" in queryResult.url:
            ...
            if number in numbers:
                ...
                return "http://www.javlibrary.com/ja" + detailurl.strip('.')
        return None
